...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 selection:bg-brand-teal selection:text-white font-sans scroll-smooth">
      ...
      <section id="opportunite" className="py-24 bg-gradient-to-b from-slate-900 to-slate-950 text-white overflow-hidden relative">
        {/* Decorative ambient background glows */}
        <div className="absolute top-1/4 right-0 w-96 h-96 bg-brand-teal/10 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5 grid grid-cols-2 gap-6 relative">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-tr from-brand-teal/15 to-indigo-500/15 rounded-full blur-3xl pointer-events-none"></div>
              
              <div className="space-y-6 relative z-10 mt-8">
                {/* Card 1: Qualité de Produit */}
                <div className="bg-slate-900/70 backdrop-blur-md border border-slate-800 hover:border-emerald-500/50 p-6 sm:p-8 rounded-3xl shadow-[0_4px_25px_rgba(0,0,0,0.3)] hover:shadow-[0_15px_30px_rgba(16,185,129,0.15)] transition-all duration-500 space-y-5 hover:-translate-y-2 group cursor-pointer relative overflow-hidden">
                  ...
                  <div className="absolute -bottom-8 -right-8 w-24 h-24 bg-emerald-500/5 rounded-full blur-2xl group-hover:bg-emerald-500/10 transition-all duration-500"></div>
                  
                  <div className="w-14 h-14 bg-slate-900/80 border border-slate-750/30 rounded-2xl flex items-center justify-center text-emerald-400 group-hover:scale-110 group-hover:bg-gradient-to-tr group-hover:from-emerald-500 group-hover:to-teal-500 group-hover:text-white group-hover:border-transparent group-hover:shadow-[0_8px_20px_rgba(16,185,129,0.3)] transition-all duration-500 shadow-md">
                    <BookmarkCheck className="w-7 h-7" />
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-extrabold text-white text-lg sm:text-xl group-hover:text-emerald-400 transition-colors">Qualité de Produit</h4>
                    <p className="text-[13px] text-slate-300 font-medium leading-relaxed">Des produits bio-technologiques brevetés et reconnus mondialement pour leur efficacité.</p>
                  </div>
                </div>

                {/* Card 2: Revenus Hebdomadaires */}
                <div className="bg-slate-900/70 backdrop-blur-md border border-slate-800 hover:border-brand-teal/50 p-6 sm:p-8 rounded-3xl shadow-[0_4px_25px_rgba(0,0,0,0.3)] hover:shadow-[0_15px_30px_rgba(27,153,175,0.15)] transition-all duration-500 space-y-5 hover:-translate-y-2 group cursor-pointer relative overflow-hidden">
                  ...
                  {/* Glowing background card element */}
                  <div className="absolute -bottom-8 -right-8 w-24 h-24 bg-brand-teal/5 rounded-full blur-2xl group-hover:bg-brand-teal/10 transition-all duration-500"></div>
                  
                  <div className="w-14 h-14 bg-slate-900/80 border border-slate-750/30 rounded-2xl flex items-center justify-center text-brand-teal group-hover:scale-110 group-hover:bg-gradient-to-tr group-hover:from-brand-teal group-hover:to-cyan-500 group-hover:text-white group-hover:border-transparent group-hover:shadow-[0_8px_20px_rgba(27,153,175,0.3)] transition-all duration-500 shadow-md">
                    <TrendingUp className="w-7 h-7" />
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-extrabold text-white text-lg sm:text-xl group-hover:text-brand-teal transition-colors">Revenus Hebdomadaires</h4>
                    <p className="text-[13px] text-slate-300 font-medium leading-relaxed">Un plan de rémunération généreux et transparent basé sur les PV de votre réseau de vente.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="bg-slate-900/70 backdrop-blur-md border border-slate-800 hover:border-amber-500/50 p-6 sm:p-8 rounded-3xl shadow-[0_4px_25px_rgba(0,0,0,0.3)] hover:shadow-[0_15px_30px_rgba(245,158,11,0.15)] transition-all duration-500 space-y-5 hover:-translate-y-2 group cursor-pointer relative overflow-hidden">
                  ...
                  {/* Glowing background card element */}
                  <div className="absolute -bottom-8 -right-8 w-24 h-24 bg-amber-500/5 rounded-full blur-2xl group-hover:bg-amber-500/10 transition-all duration-500"></div>
                  
                  <div className="w-14 h-14 bg-slate-900/80 border border-slate-750/30 rounded-2xl flex items-center justify-center text-amber-400 group-hover:scale-110 group-hover:bg-gradient-to-tr group-hover:from-amber-500 group-hover:to-orange-500 group-hover:text-white group-hover:border-transparent group-hover:shadow-[0_8px_20px_rgba(245,158,11,0.3)] transition-all duration-500 shadow-md">
                    <Star className="w-7 h-7" />
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-extrabold text-white text-lg sm:text-xl group-hover:text-amber-500 transition-colors">Voyages & Voitures</h4>
                    <p className="text-[13px] text-slate-300 font-medium leading-relaxed">Des challenges réguliers motivants pour remporter des voyages, voitures et bourses d'études.</p>
                  </div>
                </div>

                {/* Card 4: Liberté Financière */}
                <div className="bg-slate-900/70 backdrop-blur-md border border-slate-800 hover:border-indigo-500/50 p-6 sm:p-8 rounded-3xl shadow-[0_4px_25px_rgba(0,0,0,0.3)] hover:shadow-[0_15px_30px_rgba(99,102,241,0.15)] transition-all duration-500 space-y-5 hover:-translate-y-2 group cursor-pointer relative overflow-hidden">
                  ...
                  {/* Glowing background card element */}
                  <div className="absolute -bottom-8 -right-8 w-24 h-24 bg-indigo-500/5 rounded-full blur-2xl group-hover:bg-indigo-500/10 transition-all duration-500"></div>
                  
                  <div className="w-14 h-14 bg-slate-900/80 border border-slate-750/30 rounded-2xl flex items-center justify-center text-indigo-400 group-hover:scale-110 group-hover:bg-gradient-to-tr group-hover:from-indigo-500 group-hover:to-purple-500 group-hover:text-white group-hover:border-transparent group-hover:shadow-[0_8px_20px_rgba(99,102,241,0.3)] transition-all duration-500 shadow-md">
                    <Globe className="w-7 h-7" />
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-extrabold text-white text-lg sm:text-xl group-hover:text-indigo-400 transition-colors">Liberté Financière</h4>
                    <p className="text-[13px] text-slate-300 font-medium leading-relaxed">Travaillez à votre propre rythme, fixez vos objectifs et bâtissez votre entreprise pérenne.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="space-y-4">
                <div className="inline-flex items-center space-x-2 bg-brand-teal/20 text-brand-teal px-3 py-1.5 rounded-full border border-brand-teal/30">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white leading-tight">
                  L'opportunité d'affaire <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-teal via-emerald-400 to-indigo-400">Longrich</span>
                </h2>
              ...
              <div className="relative pl-8 space-y-10 border-l-2 border-slate-800 ml-4 pt-2">
                ...
                <div className="relative group/step cursor-pointer">
                  ...
                  <div className="absolute -left-[45px] top-0.5 w-[26px] h-[26px] rounded-full bg-slate-900 border-2 border-brand-teal flex items-center justify-center shadow-md transition-all duration-300 group-hover/step:scale-110 group-hover/step:border-brand-teal-dark group-hover/step:shadow-brand-teal/20">
                  ...
                  <div className="space-y-1 bg-slate-900/0 hover:bg-slate-800/40 p-4 -my-4 rounded-2xl transition-all duration-350">
                    <h5 className="font-extrabold text-slate-100 text-base sm:text-lg group-hover/step:text-brand-teal transition-colors flex items-center">
                ...
                <div className="relative group/step cursor-pointer">
                  {/* Outer pulse indicator */}
                  <div className="absolute -left-[45px] top-0.5 w-[26px] h-[26px] rounded-full bg-slate-900 border-2 border-emerald-500 flex items-center justify-center shadow-md transition-all duration-300 group-hover/step:scale-110 group-hover/step:border-emerald-600 group-hover/step:shadow-emerald-500/20">
                    <div className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-ping absolute"></div>
                    <div className="w-2.5 h-2.5 rounded-full bg-emerald-500"></div>
                  </div>
                  <div className="space-y-1 bg-slate-900/0 hover:bg-slate-800/40 p-4 -my-4 rounded-2xl transition-all duration-350">
                    <h5 className="font-extrabold text-slate-100 text-base sm:text-lg group-hover/step:text-emerald-600 transition-colors flex items-center">
                ...
                <div className="relative group/step cursor-pointer">
                  {/* Outer pulse indicator */}
                  <div className="absolute -left-[45px] top-0.5 w-[26px] h-[26px] rounded-full bg-slate-900 border-2 border-indigo-500 flex items-center justify-center shadow-md transition-all duration-300 group-hover/step:scale-110 group-hover/step:border-indigo-600 group-hover/step:shadow-indigo-500/20">
                    <div className="w-2.5 h-2.5 rounded-full bg-indigo-500 animate-ping absolute"></div>
                    <div className="w-2.5 h-2.5 rounded-full bg-indigo-500"></div>
                  </div>
                  <div className="space-y-1 bg-slate-900/0 hover:bg-slate-800/40 p-4 -my-4 rounded-2xl transition-all duration-350">
                    <h5 className="font-extrabold text-slate-100 text-base sm:text-lg group-hover/step:text-indigo-400 transition-colors flex items-center">
                      Développez votre Équipe
                      <ChevronRight className="w-4 h-4 ml-1.5 opacity-0 -translate-x-2 group-hover/step:opacity-100 group-hover/step:translate-x-0 transition-all duration-350 text-indigo-400" />
                    </h5>
                    <p className="text-xs sm:text-sm text-slate-400 font-medium leading-relaxed">
              ...
              <div className="pt-4">
                <a 
                  href="#contact"
                  className="inline-flex items-center px-8 py-4.5 bg-gradient-to-r from-slate-100 to-white hover:from-brand-teal hover:to-brand-teal-dark text-slate-900 hover:text-white rounded-2xl font-black text-sm transition-all duration-300 hover:scale-[1.02] shadow-lg shadow-black/10 hover:shadow-brand-teal/20 group cursor-pointer"
                >
